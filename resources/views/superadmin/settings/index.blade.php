                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div class="md:col-span-2">
                            ...
                            <textarea name="company_address" rows="2"
                                class="w-full px-4 py-2 border border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-red-500">{{ $settings['company_address']->value ?? '' }}</textarea>
                        </div>
                    ...
                    <div class="flex gap-4 pt-6 border-t border-slate-800">
                        <label class="flex items-center">
                            <input type="checkbox" name="enable_two_factor" value="1" @checked(($settings['enable_two_factor']->value ?? false))
                                class="rounded">
                            <span class="ml-2 text-sm font-medium text-slate-300">Aktifkan Two-Factor Authentication</span>
                        </label>
                    </div>
