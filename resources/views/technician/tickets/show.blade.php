    ...
    <div class="py-12 bg-gray-50 min-h-screen">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-6 px-4 sm:px-0">
                <a href="{{ route('technician.tickets.index') }}" class="inline-flex items-center text-gray-600 hover:text-gray-900 font-medium transition">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-8 border-t border-gray-100 pt-8">
                        ...
                        <div class="space-y-4">
                            ...
                            <div>
                                ...
                                <span class="block text-lg font-semibold text-gray-800">{{ $ticket->customer->user->name ?? 'N/A' }}</span>
                            </div>
                            ...
                            <div>
                                ...
                                <span class="inline-flex items-center px-3 py-1 rounded-lg bg-blue-50 text-blue-700 font-bold text-sm mt-1">
                                    {{ $ticket->customer->lead->package->name ?? 'Paket Kustom' }}
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="space-y-4">
                            ...
                            <div class="bg-gray-50 p-4 rounded-xl border border-gray-200 h-full flex flex-col justify-between">
                                <div class="flex items-start mb-4">
                                    ...
                                    <p class="text-gray-700 text-sm leading-relaxed">{{ $ticket->customer->address_installation ?? 'Alamat belum diinput' }}</p>
                                </div>
                                
                                @if($ticket->customer->coordinates)
                                    <a href="https://maps.google.com/?q={{ $ticket->customer->coordinates }}" target="_blank" class="block w-full text-center bg-white border border-gray-300 text-gray-700 font-bold py-2 rounded-lg hover:bg-gray-100 hover:text-blue-600 transition text-sm shadow-sm">
                                        Buka di Google Maps
                                    </a>
                                @else
                                    <span class="block w-full text-center bg-gray-100 text-gray-400 py-2 rounded-lg text-sm border border-gray-200">Tidak ada koordinat</span>
                                @endif
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="flex">
                                ...
                                <div class="ml-3">
                                    <p class="text-sm text-yellow-800 font-medium">
                                        Dengan menekan tombol di bawah, Anda bertanggung jawab penuh untuk menyelesaikan instalasi ini. Status tiket akan berubah menjadi <strong class="font-bold">ASSIGNED</strong> dan hilang dari Bursa Tugas.
                                    </p>
                                </div>
                            </div>
                        </div>
