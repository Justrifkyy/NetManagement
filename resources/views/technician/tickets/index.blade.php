        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4 sm:px-0">
                @forelse($tickets as $ticket)
                    <div class="bg-white rounded-xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-md transition duration-300 relative group">
                        ...
                        <div class="p-6">
                            ...
                            <div class="space-y-3 border-t border-gray-100 pt-4">
                                <div class="flex items-start text-sm text-gray-600">
                                    ...
                                    <span class="font-medium">{{ $ticket->customer->user->name ?? 'Nama Pelanggan' }}</span>
                                </div>
                                <div class="flex items-start text-sm text-gray-600">
