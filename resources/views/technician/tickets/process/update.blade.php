        ...
        <div class="max-w-5xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="bg-white shadow-sm sm:rounded-xl p-6 mb-8 border-l-4 border-blue-600 relative overflow-hidden">
                ...
                <div class="mt-4 flex flex-wrap gap-2 relative z-10">
                    <span class="px-3 py-1 bg-blue-100 text-blue-800 rounded-lg text-xs font-bold border border-blue-200">{{ $ticket->customer->lead->package->name ?? 'Paket N/A' }}</span>
                    <a href="https://wa.me/{{ $ticket->customer->phone_number }}" target="_blank" class="px-3 py-1 bg-green-100 text-green-800 rounded-lg text-xs font-bold border border-green-200 flex items-center hover:bg-green-200 transition">
                    ...
                    @if($ticket->customer->coordinates)
                        <a href="https://www.google.com/maps/search/?api=1&query={{ str_replace(' ', '', $ticket->customer->coordinates) }}" target="_blank" class="px-3 py-1 bg-red-100 text-red-800 rounded-lg text-xs font-bold border border-red-200 flex items-center hover:bg-red-200 transition">
            ...
            <form action="{{ route('technician.process.store', $ticket->id) }}" method="POST" enctype="multipart/form-data" class="space-y-8">
                ...
                <div class="fixed bottom-0 left-0 right-0 p-4 bg-white border-t border-gray-200 md:static md:bg-transparent md:border-0 md:p-0 flex justify-end z-50 shadow-lg md:shadow-none">
