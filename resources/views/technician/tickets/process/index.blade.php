    ...
    <div class="py-10 bg-sky-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8 px-4 sm:px-0 flex justify-between items-center">
                ...
                <a href="{{ route('technician.tickets.index') }}" class="text-sm font-bold text-sky-600 hover:text-sky-800 flex items-center">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 px-4 sm:px-0">
                @forelse($tickets as $ticket)
                    <div class="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden hover:shadow-xl transition duration-300 flex flex-col">
                        
                        <div class="px-6 py-4 border-b border-gray-100 flex justify-between items-center
                            {{ $ticket->status == 'resolved' ? 'bg-green-50' : 'bg-yellow-50' }}">
                        ...
                        <div class="px-6 py-4 bg-gray-50 border-t border-gray-100">
                            ...
                            @else
                                <div class="grid grid-cols-2 gap-2">
                                    <a href="{{ route('technician.process.show', $ticket->id) }}" class="flex items-center justify-center bg-white border border-gray-300 text-gray-700 font-bold py-2 px-4 rounded-lg hover:bg-gray-50 transition">
                                        <svg class="w-5 h-5 mr-1" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                        Lihat
                                    </a>
                                    <a href="{{ route('technician.process.edit', $ticket->id) }}" class="flex items-center justify-center bg-yellow-100 text-yellow-700 font-bold py-2 px-4 rounded-lg hover:bg-yellow-200 transition">
                                        Edit
                                    </a>
                                </div>
                            @endif
                ...
                @empty
                    <div class="col-span-1 md:col-span-3 text-center py-20 bg-white rounded-xl border border-dashed border-gray-300">
                        ...
                        <a href="{{ route('technician.tickets.index') }}" class="inline-flex items-center px-6 py-3 bg-blue-600 text-white font-bold rounded-lg hover:bg-blue-700 transition">
                            Ke Bursa Tugas
                        </a>
                    </div>
                @endforelse
