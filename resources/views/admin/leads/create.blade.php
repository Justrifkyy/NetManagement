    ...
    <div class="py-10 bg-slate-950 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-extrabold text-white mt-2">Buat Lead Baru</h2>
            </div>
            ...
            <div class="bg-slate-900 rounded-xl shadow-sm border border-slate-800 p-8">
                <form action="{{ route('admin.leads.store') }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="border-b border-slate-800 pb-6">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="address_ktp" rows="2" placeholder="Alamat sesuai KTP"
                                class="w-full px-4 py-3 border border-slate-700 rounded-lg bg-slate-800 text-white focus:outline-none focus:ring-2 focus:ring-amber-500"></textarea>
                        </div>
                    ...
                    <div class="flex gap-4 pt-4">
                        ...
                        <a href="{{ route('admin.leads.index') }}" class="px-6 py-3 border border-slate-700 rounded-lg hover:bg-slate-800 font-medium text-white">
                            Batal
                        </a>
                    </div>
                </form>
