    ...
    <div class="py-10 bg-gray-50 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-extrabold text-gray-900 mt-2">Edit Lead</h2>
            </div>
            ...
            <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-8">
                <form action="{{ route('admin.leads.update', $lead) }}" method="POST" enctype="multipart/form-data" class="space-y-6">
                    ...
                    <div class="border-b border-gray-200 pb-6">
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="address_ktp" rows="2"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ $lead->address_ktp }}</textarea>
                        </div>
                        ...
                        <div class="mt-6">
                            ...
                            <textarea name="address_installation" rows="2"
                                class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ $lead->address_installation }}</textarea>
                        </div>
                        ...
                        <div class="mt-6 grid grid-cols-1 md:grid-cols-3 gap-6">
                            <div>
                                ...
                                <textarea name="notes_summary" rows="2"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ $lead->notes_summary }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-900 mb-2">Catatan Hambatan</label>
                                <textarea name="notes_obstacle" rows="2"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ $lead->notes_obstacle }}</textarea>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-gray-900 mb-2">Catatan Khusus</label>
                                <textarea name="notes_special" rows="2"
                                    class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500">{{ $lead->notes_special }}</textarea>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex gap-4 pt-4">
                        ...
                        <a href="{{ route('admin.leads.show', $lead) }}" class="px-6 py-3 border border-gray-300 rounded-lg hover:bg-gray-50 font-medium">
                            Batal
                        </a>
                    </div>
                </form>
