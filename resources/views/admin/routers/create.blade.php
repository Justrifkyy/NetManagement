    ...
    <div class="py-10 bg-slate-950 min-h-screen selection:bg-indigo-500/30">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-extrabold text-transparent bg-clip-text bg-gradient-to-r from-white to-slate-400 tracking-tight">Tambah Perangkat Baru</h2>
            </div>
                ...
                <form action="{{ route('admin.routers.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            ...
                            <input type="text" name="name" required placeholder="Contoh: Router Pusat BTP"
                        ...
                        <div>
                            ...
                            <input type="text" name="location" required placeholder="Contoh: POP Antang"
                                class="w-full px-4 py-3 bg-slate-800/50 text-slate-100 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all placeholder-slate-500">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="relative">
                                ...
                                <input type="text" name="ip_address" required placeholder="192.168.x.x"
                        ...
                        <div>
                            ...
                            <input type="text" name="brand" required placeholder="Mikrotik, ZTE, Huawei..."
                                class="w-full px-4 py-3 bg-slate-800/50 text-slate-100 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all placeholder-slate-500">
                        </div>
                        ...
                        <div>
                            ...
                            <select name="type" required class="w-full px-4 py-3 bg-slate-800/50 text-slate-100 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all appearance-none cursor-pointer">
                                <option value="" disabled selected class="bg-slate-800 text-slate-500">Pilih Kategori Tipe</option>
                                <option value="OLT" class="bg-slate-800">OLT (Optical Line Terminal)</option>
                                <option value="Router" class="bg-slate-800">Router / Mikrotik</option>
                                <option value="AP" class="bg-slate-800">AP (Access Point)</option>
                                <option value="ODP" class="bg-slate-800">ODP (Optical Distribution Point)</option>
                            </select>
                        </div>

                        <div>
                            <label class="block text-sm font-bold text-slate-300 mb-2">Status Awal</label>
                            <select name="is_active" required class="w-full px-4 py-3 bg-slate-800/50 text-slate-100 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 transition-all appearance-none cursor-pointer">
                                <option value="1" class="bg-slate-800">Langsung Aktif (Online)</option>
                                <option value="0" class="bg-slate-800">Nonaktif Sementara (Offline)</option>
                            </select>
                        </div>
                    </div>
