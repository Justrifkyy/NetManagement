    ...
    <div class="py-10 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8 px-4 sm:px-0">
                ...
                <h2 class="text-3xl font-extrabold text-gray-900 mt-2">Profil Saya</h2>
            </div>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 px-4 sm:px-0">
                ...
                <div class="lg:col-span-2 space-y-6">
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h3 class="text-xl font-bold text-gray-900 mb-6">Informasi Profil</h3>
                    ...
                    <!-- Change Password -->
                    <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                        <h3 class="text-xl font-bold text-gray-900 mb-6">Ubah Password</h3>

                        <form action="{{ route('admin.profile.updatePassword') }}" method="POST" class="space-y-4">
                            @csrf

                            <div>
                                <label class="block text-sm font-medium text-gray-700 mb-2">Password Lama <span class="text-red-600">*</span></label>
                ...
                <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
                    ...
                    <div class="space-y-4">
                        <div>
                            <label class="text-xs font-medium text-gray-600 uppercase">Role</label>
                            <p class="text-gray-900 font-semibold mt-1 capitalize">{{ str_replace('_', ' ', $user->role) }}</p>
                        </div>
                        ...
                        <div>
                            <label class="text-xs font-medium text-gray-600 uppercase">Bergabung Sejak</label>
                            <p class="text-gray-900 mt-1">{{ $user->created_at->format('d M Y') }}</p>
                        </div>

                        <div>
                            <label class="text-xs font-medium text-gray-600 uppercase">Update Terakhir</label>
                            <p class="text-gray-900 mt-1">{{ $user->updated_at->format('d M Y H:i') }}</p>
                        </div>
                    </div>
                </div>
            </div>
