    ...
    <div class="py-10 bg-slate-950 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-extrabold text-white mt-2">Buat Tiket Baru</h2>
            </div>
            ...
            <div class="bg-slate-900 rounded-xl shadow-sm border border-slate-800 p-8">
                <form action="{{ route('admin.tickets.store') }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-white mb-2">Teknisi (Opsional)</label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-white mb-2">Catatan (Opsional)</label>
                        <textarea name="notes" rows="4" placeholder="Masukkan catatan tambahan..."
                            class="w-full px-4 py-3 border border-slate-700 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500"></textarea>
                    </div>
                    ...
                    <div class="flex gap-4 pt-4">
                        ...
                        <a href="{{ route('admin.tickets.index') }}" class="px-6 py-3 border border-slate-700 rounded-lg hover:bg-slate-950 font-medium">
                            Batal
                        </a>
                    </div>
                </form>
