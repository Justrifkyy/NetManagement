    ...
    <div class="py-10 bg-slate-950 min-h-screen">
        <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="mb-8">
                ...
                <h2 class="text-3xl font-extrabold text-white mt-2">Edit Tiket #{{ $ticket->id }}</h2>
            </div>
            ...
            <div class="bg-slate-900 rounded-xl shadow-sm border border-slate-800 p-8">
                <form action="{{ route('admin.tickets.update', $ticket) }}" method="POST" class="space-y-6">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-semibold text-white mb-2">Pelanggan <span class="text-red-600">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-white mb-2">Tipe Tiket <span class="text-red-600">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-semibold text-white mb-2">Subjek <span class="text-red-600">*</span></label>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div>
                            <label class="block text-sm font-semibold text-white mb-2">Status <span class="text-red-600">*</span></label>
                        ...
                        <div>
                            <label class="block text-sm font-semibold text-white mb-2">Teknisi</label>
                    ...
                    @if ($ticket->type === 'survey')
                        <div class="border-t border-slate-800 pt-6">
                            <h3 class="text-lg font-bold text-white mb-4">Detail Survey</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    ...
                                    <input type="date" name="survey_date" value="{{ $ticket->survey_date }}"
                                        class="w-full px-4 py-3 border border-slate-700 rounded-lg">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-white mb-2">Status Survey</label>
                                    <input type="text" name="survey_status" value="{{ $ticket->survey_status }}"
                                        class="w-full px-4 py-3 border border-slate-700 rounded-lg">
                                </div>
                            </div>
                            <div>
                                <label class="block text-sm font-semibold text-white mb-2 mt-4">Catatan Survey</label>
                                <textarea name="survey_notes" rows="4"
                                    class="w-full px-4 py-3 border border-slate-700 rounded-lg">{{ $ticket->survey_notes }}</textarea>
                            </div>
                        </div>
                    @endif
                    ...
                    @if ($ticket->type === 'installation')
                        <div class="border-t border-slate-800 pt-6">
                            <h3 class="text-lg font-bold text-white mb-4">Detail Instalasi</h3>
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label class="block text-sm font-semibold text-white mb-2">Tanggal Instalasi</label>
                                    <input type="date" name="installation_date" value="{{ $ticket->installation_date }}"
                                        class="w-full px-4 py-3 border border-slate-700 rounded-lg">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-white mb-2">Tipe Koneksi</label>
                                    <input type="text" name="connection_type" value="{{ $ticket->connection_type }}" placeholder="FTTH, Coaxial, dll"
                                        class="w-full px-4 py-3 border border-slate-700 rounded-lg">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-white mb-2">Panjang Kabel (m)</label>
                                    <input type="number" name="cable_length" value="{{ $ticket->cable_length }}"
                                        class="w-full px-4 py-3 border border-slate-700 rounded-lg">
                                </div>
                                <div>
                                    <label class="block text-sm font-semibold text-white mb-2">Status Instalasi</label>
                            ...
                            <div>
                                <label class="block text-sm font-semibold text-white mb-2 mt-4">Catatan Instalasi</label>
                                <textarea name="installation_notes" rows="4"
                                    class="w-full px-4 py-3 border border-slate-700 rounded-lg">{{ $ticket->installation_notes }}</textarea>
                            </div>
                        </div>
                    @endif
                    ...
                    <div class="flex gap-4 pt-4">
                        ...
                        <a href="{{ route('admin.tickets.show', $ticket) }}" class="px-6 py-3 border border-slate-700 rounded-lg hover:bg-slate-950 font-medium">
                            Batal
                        </a>
                    </div>
                </form>
