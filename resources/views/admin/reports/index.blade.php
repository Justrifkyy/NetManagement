    ...
    <div class="py-10 bg-slate-950 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6 px-4 sm:px-0">
                <a href="#" class="bg-slate-900 rounded-xl shadow-sm border border-slate-800 p-6 hover:shadow-md transition">
                    ...
                    <button class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 text-sm">Lihat Laporan</button>
                </a>
                ...
                <a href="#" class="bg-slate-900 rounded-xl shadow-sm border border-slate-800 p-6 hover:shadow-md transition">
                    ...
                    <button class="px-4 py-2 bg-purple-600 text-white rounded-lg hover:bg-purple-700 text-sm">Lihat Log</button>
                </a>
