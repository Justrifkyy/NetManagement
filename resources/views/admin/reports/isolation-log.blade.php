        ...
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="GET" class="bg-slate-900/80 rounded-2xl border border-slate-800 p-6 mb-8 mx-4 sm:mx-0 flex flex-col md:flex-row items-end gap-4">
                <div class="w-full md:w-1/3">
                    ...
                    <input type="date" name="from_date" value="{{ $fromDate }}" style="color-scheme: dark;"
                        class="w-full px-4 py-3 bg-slate-800/50 text-slate-300 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-amber-500/50 focus:border-amber-500 transition-all">
                </div>
                <div class="w-full md:w-1/3">
                ...
                <div class="flex gap-3 w-full md:w-auto">
                    <button type="submit" class="flex-1 md:flex-none px-6 py-3 bg-amber-600 text-white font-bold rounded-xl hover:bg-amber-500 transition-all">Filter</button>
                    <a href="{{ route('admin.reports.isolationLog') }}" class="flex-1 md:flex-none px-6 py-3 bg-slate-800 text-slate-300 font-bold rounded-xl border border-slate-700 hover:bg-slate-700 transition-all text-center">Reset</a>
                </div>
            </form>
            ...
            <div class="bg-slate-900/80 rounded-2xl border border-slate-800 overflow-hidden mx-4 sm:mx-0">
                <div class="px-6 py-5 border-b border-slate-700/50 bg-slate-800/30 flex items-center gap-3">
                    ...
                    <h3 class="font-bold text-white">{{ $logs->count() }} Catatan Isolasi</h3>
                </div>
                    ...
                    <table class="w-full text-left text-sm">
                        <thead class="bg-slate-800/50 text-xs font-semibold text-slate-400 uppercase tracking-wider border-b border-slate-700/50">
                            <tr>
                                ...
                                <th class="px-6 py-4">Deskripsi / Alasan</th>
                            </tr>
                        </thead>
                                ...
                                <tr>
                                    <td colspan="3" class="px-6 py-16 text-center">
                                        <div class="flex flex-col items-center text-slate-400">
                                            <svg class="w-12 h-12 mb-4 text-slate-600" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="1.5" d="M18.364 18.364A9 9 0 005.636 5.636m12.728 12.728A9 9 0 015.636 5.636m12.728 12.728L5.636 5.636"></path></svg>
                                            <p class="font-bold text-slate-300">Tidak ada log isolasi</p>
                                            <p class="text-sm mt-1">Belum ada pelanggan yang diisolir pada periode ini.</p>
                                        </div>
                                    </td>
                                </tr>
                            @endforelse
