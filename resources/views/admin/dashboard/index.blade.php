    ...
    <div class="py-10 bg-slate-950 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="mb-8 px-4 sm:px-0 flex flex-col md:flex-row justify-between items-start md:items-center">
                <div>
                    <h2 class="text-3xl font-black text-white tracking-tight">Dashboard Admin</h2>
                    <p class="text-slate-400 mt-1">Pusat kontrol operasional, verifikasi QC, dan ringkasan keuangan.</p>
                </div>
                <div class="mt-4 md:mt-0">
                    <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-bold bg-purple-900/40 text-purple-300 border border-purple-800 shadow-sm">
                        <span class="flex w-2 h-2 bg-purple-500 rounded-full mr-2"></span>
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 px-4 sm:px-0 mb-8">
                ...
                <div class="bg-slate-900 rounded-2xl p-6 shadow-lg border border-slate-800 hover:border-amber-500 transition flex items-center relative overflow-hidden">
                    <div class="absolute right-0 top-0 mt-4 mr-4 text-green-900/20">
                    ...
                    <div class="p-3 bg-green-900/20 text-green-400 rounded-xl mr-4 z-10">
                    ...
                    <div class="z-10">
                        <p class="text-xs font-bold text-slate-400 uppercase tracking-wider">Pelanggan Aktif</p>
                        <h3 class="text-3xl font-black text-white mt-1">{{ $stats['active_subs'] }}</h3>
                    </div>
                </div>

                <div class="bg-slate-900 rounded-2xl p-6 shadow-lg border border-slate-800 hover:border-amber-500 transition flex items-center relative overflow-hidden">
                    <div class="absolute right-0 top-0 mt-4 mr-4 text-blue-900/20">
                    ...
                    <div class="p-3 bg-blue-900/20 text-blue-400 rounded-xl mr-4 z-10">
                    ...
                    <div class="z-10">
                        ...
                        <h3 class="text-2xl font-black text-white mt-1">Rp {{ number_format($stats['total_revenue'], 0, ',', '.') }}</h3>
                    </div>
                </div>

                <div class="bg-slate-900 rounded-2xl p-6 shadow-lg border border-red-900/30 hover:border-amber-500 transition flex items-center relative overflow-hidden">
                    <div class="absolute right-0 top-0 mt-4 mr-4 text-red-900/20">
                    ...
                    <div class="p-3 bg-red-900/20 text-red-400 rounded-xl mr-4 z-10">
                        <svg class="w-8 h-8" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z"></path></svg>
                    </div>
                    <div class="z-10">
                        <p class="text-xs font-bold text-red-400 uppercase tracking-wider">Menunggu QC</p>
                        <h3 class="text-3xl font-black text-red-400 mt-1">{{ $stats['pending_qc'] }}</h3>
                    </div>
                </div>

                <div class="bg-slate-900 rounded-2xl p-6 shadow-lg border border-slate-800 hover:border-amber-500 transition flex items-center relative overflow-hidden">
                    <div class="absolute right-0 top-0 mt-4 mr-4 text-amber-900/20">
                    ...
                    <div class="p-3 bg-amber-900/20 text-amber-400 rounded-xl mr-4 z-10">
                    ...
                    <div class="z-10">
                        <p class="text-xs font-bold text-slate-400 uppercase tracking-wider">Prospek Baru</p>
                        <h3 class="text-3xl font-black text-white mt-1">{{ $stats['new_leads'] }}</h3>
                    </div>
                </div>
            </div>

            <div class="px-4 sm:px-0">
                <div class="bg-slate-900 rounded-lg shadow-lg border border-slate-800 overflow-hidden">
                    <div class="px-6 py-4 bg-slate-800 border-b border-slate-700 flex justify-between items-center">
                        <div>
                            ...
                            <p class="text-sm text-slate-400 mt-1">Cek foto bukti pasang sebelum mengaktifkan internet pelanggan.</p>
                        </div>
                    ...
                    <div class="overflow-x-auto">
                        <table class="min-w-full divide-y divide-gray-200">
                            <thead class="bg-white">
                                <tr>
                                    <th class="px-6 py-4 text-left text-xs font-bold text-slate-400 uppercase tracking-wider">Tiket / Layanan</th>
                                    <th class="px-6 py-4 text-left text-xs font-bold text-slate-400 uppercase tracking-wider">Pelanggan</th>
                                    <th class="px-6 py-4 text-left text-xs font-bold text-slate-400 uppercase tracking-wider">Teknisi</th>
                                    <th class="px-6 py-4 text-left text-xs font-bold text-slate-400 uppercase tracking-wider">Waktu Selesai</th>
                                ...
                                @forelse($pendingTickets as $ticket)
                                    <tr class="hover:bg-red-50 transition">
                                        <td class="px-6 py-4">
                                            ...
                                            <div class="text-xs text-slate-400 mt-1">Status Laporan: <span class="text-green-600 font-bold">{{ $ticket->installation_status }}</span></div>
                                        </td>
                                        ...
                                        <td class="px-6 py-4 whitespace-nowrap">
                                            <span class="px-3 py-1 inline-flex text-xs leading-5 font-semibold rounded-full bg-slate-800 text-slate-300 border border-slate-800">
                                    ...
                                    <tr>
                                        <td colspan="5" class="px-6 py-12 text-center text-slate-400">
                                            <div class="flex flex-col items-center justify-center">
                                                ...
                                                <p class="font-bold text-slate-300">Tidak ada tiket yang menunggu verifikasi.</p>
