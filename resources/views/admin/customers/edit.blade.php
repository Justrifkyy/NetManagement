    ...
    <div class="py-10 bg-gray-50 min-h-screen">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <div class="mb-8 px-4 sm:px-0">
                ...
                <h2 class="text-3xl font-extrabold text-gray-900 mt-2">Edit Data Pelanggan</h2>
            </div>
            ...
            <div class="max-w-2xl bg-white rounded-xl shadow-sm border border-gray-200 p-6 px-4 sm:px-0">
                <form action="{{ route('admin.customers.update', $customer) }}" method="POST" class="space-y-6">
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">No. HP <span class="text-red-600">*</span></label>
                    ...
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-2">Alamat Instalasi <span class="text-red-600">*</span></label>
                        <textarea name="address_installation" required rows="4"
                            class="w-full px-4 py-2 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-purple-500">{{ $customer->address_installation }}</textarea>
                    ...
                    <div class="flex gap-4 pt-4">
                        ...
                        <a href="{{ route('admin.customers.index') }}" class="px-6 py-2 border border-gray-300 rounded-lg hover:bg-gray-50">
                            Batal
                        </a>
                    </div>
                </form>
